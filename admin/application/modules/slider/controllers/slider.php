<?php  class Slider extends MX_Controller 
{
	...
	$data['banners'] = $this->tutors_model->getTableData('banners');
	//print_r($data['tutor']);
	$data['main_content'] = 'banners';
...
$res=$this->tutors_model->insertData('banners',$tutor_data);
				if($res)
				{
				  $data['alert_message_success']='Banner Uploaded  Successfully<br>';
				}
				else
				{
...
$this->tutors_model->delete_tab_row('banners',$url);
         redirect("slider/");
	}
		}