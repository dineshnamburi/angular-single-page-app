<div id="page-wrapper">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header dashboard-padding"><small>Update Testimonial</small></h1>
      </div>
    </div>
    <div class="row">
...
<div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <input type="text" name="designation" class="form-control"  value="<?php echo $testimonial['designation']  ?>" required>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
             ...
             <?php $content=html_entity_decode($testimonial['content'],ENT_QUOTES); echo $this->ckeditor->editor('content',$content);?>
            </div>
          </div>
