<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header dashboard-padding"><small>Edit Training</small></h1>
      </div>
    </div>
    <div class="row">
     ...
     <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          ...
          <input type="text" name="courseName" class="form-control" value="<?php echo $training['course_name']?>" placeholder="" required>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          ...
          <textarea row="3" name="description" class="form-control" placeholder=""><?php echo $training['description']?></textarea>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          ...
          <input type="number" class="form-control" value="<?php echo $training['duration']?>" name="duration" min="0" required>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="<?php echo $training['price']?>" name="price"  required>
        </div>
      </div>
    </div>
    <!--Tower-->
