  ...
  <div class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="form-group">
            ...
            <select name="p_id" class="form-control parent" id="parent" required>
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="form-group">
            ...
            <select name="c_id" class="form-control child" id="child">
              <option value="" disabled selected>Select</option>]
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="form-group">
          <label class="lable-padd">Sub-Child Name </label>
