        ...
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <input type="text" name="keywords" class="form-control" placeholder="" value="" required>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <input type="text" name="description" class="form-control" placeholder="" value="" required>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <img src="<?php echo $page['image'] ?>" style="width:100px;">
            </div>
          </div>
        </div>
