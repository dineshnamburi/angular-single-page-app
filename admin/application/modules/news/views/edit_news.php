<div id="page-wrapper">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header dashboard-padding"><small>Update News</small></h1>
      </div>
    </div>
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" placeholder="Enter Job Title*" value="<?php echo $news['title']  ?>" required>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-9">
            <div class="form-group">
             ...
             <?php $content=html_entity_decode($news['description'],ENT_QUOTES); echo $this->ckeditor->editor('content',$content);?>
            </div>
          </div>
