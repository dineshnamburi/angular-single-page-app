<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header dashboard-padding"><small>Update Client</small></h1>
      </div>
    </div>
    <div class="row">
		 ...
		 <div class="row">
          <div class="col-md-9">
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" placeholder="Enter Title*" required value="<?php echo $page['title']  ?>">
            </div>
          </div>
        </div>
		<div class="row">
          <div class="col-md-9">
            <div class="form-group">
			  ...
			  <img src="<?php echo base_url() ?>../images/client/<?php echo $page['image']  ?>" width="100px"><br />
