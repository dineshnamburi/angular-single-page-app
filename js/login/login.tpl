  ...
  <div class="panel-body">
				...
				<form class="form-horizontal" name="registerForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
                            <label class="radio-inline">
  <input type="radio" name="type" ng-model="value.type" id="inlineRadio1" value="partner" required> Partner
</label>
<label class="radio-inline">
  <input type="radio" name="type" ng-model="value.type" id="inlineRadio2" value="trainee" required> Trainee
</label>
<!--
...
-->
					...
					<div class="form-group" ng-if="value.type == 'trainee'">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="email" name="email" ng-model="value.email" class="form-control" id="inputEmail" placeholder="Email" required>
						</div>
					</div>  
					<div class="form-group">
					...
					<div class="form-group" ng-if="value.type == 'partner'">
					...
					<div class="form-group" ng-if="value.type == 'trainee'">
						...
						<div class="col-sm-8">
							<input type="text" name="postal_code" ng-model="value.postal" class="form-control" id="inputMobile" placeholder="Postal Code">
						</div></div>
						...
						<div class="form-group" ng-if="value.type == 'partner'">
							...
							<div class="col-sm-8">
								<input type="text" name="country" ng-model="value.taxId" class="form-control" id="inputMobile" placeholder="Tax No. / Vat No.">
