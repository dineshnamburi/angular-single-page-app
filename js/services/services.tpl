<div ng-include="'application/views/js/header/header.tpl'"></div>
<section id="banner">
...
<section class="special">
	...
	<p>Samasource provides end-to-end project management that connects you to our secure global workforce.</p>
</section>
...
<section class="special">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12"><img class="circle" src="assets/images/1.png">
				<div class="clearfix"></div>
				<h3>SCOPE</h3>
				<p>Build customized requirements alongside project consultants, who break down workflows into microwork</p>
			</div>
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12"><img class="circle" src="assets/images/2.png">
				<div class="clearfix"></div>
			...
			<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12"><img class="circle" src="assets/images/4.png">
				<div class="clearfix"></div>
...
<section class="text-center">
	...
	<button type="submit" class="btn btn-primary">LEARN MORE ABOUT OUR SERVICES</button><br>
</section>
<div ng-include="'application/views/js/footer/footer.tpl'"></div>